...
#if defined(ASNI_IO_DPDK) || defined(ASNI_IO_ASNI_OFFLOAD_TX)
...
#elif defined(ASNI_IO_XCHG) || defined(ASNI_IO_ASNI_OFFLOAD_TX)
    printf("Using XCHG\n");
    mbuf_pool =
