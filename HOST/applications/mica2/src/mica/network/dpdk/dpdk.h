...
struct BasicDPDKConfig {
  ...
  // ASNI
  // static constexpr uint16_t kRXDescCount = 1024;
  // static constexpr uint16_t kTXDescCount = 1024;
  // The number of RX/TX descriptors in each queue.
  // DPDK
  ...
  static constexpr uint32_t kMinLinkSpeed = 50;

  // Be verbose.
  static constexpr bool kVerbose = false;
};

template <class StaticConfig = BasicDPDKConfig> class DPDK {
public:
