...
static inline void app(struct fake_dpdk_state *fake_dpdk_state) {
...
#endif
#endif
#if defined(ASNI_DESC_PAD) && (ASNI_MODE_DPDK_BASELINE)
    ...
    ASNI_FOR_EACH_PACKET(descriptor);
    {
