...
public:
	 ...
	 *
	 * The message will be automatically generated as the result of doca_error_get_descr for the given
	...
	exception(doca_error_t error, source_loc loc)
		: runtime_error{doca_error_get_descr(error)}, m_error{error}, m_loc{loc} {}
